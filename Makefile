...
activate:
	@ echo "Activating this python Virtual Env:"
...
server:
	@ sam local start-api --docker-network lambda-local --parameter-overrides Table=Activities Region=ap-southeast-1 AWSEnv=AWS_SAM_LOCAL
